...
class TestMailController(TestCase):
    ...
    def test_send_confirmation_link_generates_safe_token_from_the_given_email(self):
        # When
    ...
    def test_send_confirmation_link_generates_confirmation_url_with_the_token(self):
        # Given
        token = 'nicetoken'
    ...
    def test_send_confirmation_link_generates_email_template_containing_url(self):
        # Given
        url = 'niceurl'
    ...
    def test_send_confirmation_link_sends_email_with_template_to_the_given_address(self):
        # Given
